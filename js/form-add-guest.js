...
function addInput(pName){
     if (counter == limit)  {
          ...
          document.getElementById(pName).insertAdjacentHTML('afterend', "<p class='form-align' id='dynamicInput'><label class='form-align' for='name" + counter + "'>Guest " + (counter + 1) + ": </label>" + " <input class='form-align' type='text' name='myInputs[]' id='name" + counter + "' size='60' maxlength='100'></p>");
